...
class Hybrid_swin_effnet(nn.Module):
    def __init__(self, feature_model = "efficientnet_b3",img_size = (128,128), channels = 13, efn_blocks = 2, swin_blocks = 2, no_classes = 1):
        super().__init__()
...
if __name__ == "__main__":
    ...
    sample = torch.randn(1, 13, 128, 128, device = "cuda")
