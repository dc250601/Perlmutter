...
class Hybrid_swin_effnet(nn.Module):
    def __init__(self, feature_model = "efficientnet_b3",img_size = (224,224), channels = 13, efn_blocks = 2, swin_blocks = 2, no_classes = 1):
        super().__init__()
        ...
        self.swin_backbone = timm.create_model("swin_tiny_patch4_window7_224",in_chans = 13)
...
if __name__ == "__main__":
    ...
    wandb.init( project = "Tau_EFFSWIN",
                name = Run_Name,
                id = Run_Id,
                resume = "allow")
    

    sample = torch.randn(1, 13, 224, 224, device = "cuda")
