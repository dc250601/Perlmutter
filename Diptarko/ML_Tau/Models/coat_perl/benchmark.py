...
if __name__ == "__main__":
    ...
    name = word.random_word.RandomWords().get_random_word()+"-"+word.random_word.RandomWords().get_random_word()+"-"+word.random_word.RandomWords().get_random_word()+"-"+word.random_word.RandomWords().get_random_word()
    os.mkdir(f"/pscratch/sd/t/train130/dc250601/{name}")
    ...
    #     hist_auc_test.append(test_auc)
        ...
        print("----------------------------------------------------")
        PATH = f"/pscratch/sd/t/train130/dc250601/{name}/model_Epoch_{epoch}.pt"
        torch.save({
                'epoch': epoch,
